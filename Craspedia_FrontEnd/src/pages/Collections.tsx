  ...
  return (
    <div className="flex flex-row flex-wrap pt-10 px-4 sm:px-10 lg:px-16 w-full gap-8">
      ...
      <div className="w-full md:w-1/4 p-6">
        ...
        <div className="border border-gray-300 p-4 mt-6 rounded-md">
          ...
          <div className="flex flex-col gap-4 text-sm font-light text-gray-700">
            {['Bags', 'Clothings', 'Home Decor', 'Toys', 'Accessories'].map((category) => (
      ...
      <div className="flex flex-col flex-1">
        ...
        {/* Product Items */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-6 py-2 w-full max-w-screen-xl">
          <ItemCard />
          <ItemCard />
          <ItemCard />
          <ItemCard />
